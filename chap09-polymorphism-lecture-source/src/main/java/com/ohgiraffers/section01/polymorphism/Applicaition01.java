...
public class Applicaition01 {
    public static void main(String[] args) {
        ...
        * 하나의 메소드 호출로 객체별로 각기 다른 방법으로 동학하게 될 수도 있다.
        *
        ...
        * 이러 동일한 매세지를 수신받아 처리하는 내용을 객체별로 다르게 할 수 있다는 장점을 가지고 있다.
        * (다양한 기능을 사용하는데 있어서 관리해야할 메세지 종류가 줄어들게 된다)
        * 다형성을 이해가기 쉬운 가장 좋은 예 이기도 하다
...
//        Rabbit r = new Animal(); 오류남 부모타입을 자식타입에게 줄 수 없음
...
//        animal1.jump(); 자료형이 부모지만 동작하는 기능이 자식메소드에 있기에 실행 안됨
//        animal2.bite();
...
//        ((Tiger) animal1).bite(); 맞는 자료형으로 형변환 해줘야함
//        ((Rabbit) animal2).jump();
        ...
        System.out.println("annimal1이 Animal과 같은지 "+(animal1 instanceof Animal));
        System.out.println("animal2 가 Rabbit과 같은지"+ (animal2 instanceof Rabbit));
