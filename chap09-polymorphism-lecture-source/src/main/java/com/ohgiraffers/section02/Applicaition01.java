...
public class Applicaition01 {
    public static void main(String[] args) {
        /*
        * 추상클래스와 추상메소드
        *  추상메소드를 1개 이상 포함하는 클래스 추상클래스 라고 한다.
...
//         Product product= new Product();
        ...
        System.out.println(smartphone instanceof Smartphone); // instanceof 같은 자료형이냐고 물어보는것
        System.out.println(smartphone instanceof Product); // smartphone은 product를 상속 받았으므로 같은 자료형
