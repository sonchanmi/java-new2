...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * api란?
        *
        * Application programming interpace는 응용 프로그램에서 사용할 수 있도록,
        * 운영체제나 프로그래밍 언어가 제공하는 기능을 제어할 수 있도록 만든 인터페이스를 뜻한다.
        * 쉽게 말해 우리가 구현할 수 없거나, 구현하기 번거로운 기능들을 jdk를 설치하면 자동으로 사용할 수 있도록
        * 제공해 놓은 소스코드 들을 의미한다.
        * 더 쉽게 말해 누가 작성해 놓은 소스 코드들을 가져다 쓰는 방법으 ㄹ본다는 말이다.
        * 모든 코드를 개발잘들이 다 외울 수 없기 때문에 api 문서를 별도로 제공해 주고 있다.
        *
        *
        * */
        ...
        /*
        * java.lang.Math
        * Math클래스는 수학에서 자주 사용되는 상수들과 함수들을 미리 구현해 놓은 클래스이다.
        * 모든 메소드는 ststic 메소드로 정의되어있다.
        *
        *
        * */
        ...
        /*원하는 범위의 난수를 구하는 공식*/
        //난수 발생 0~10
        System.out.println("난수 발생:"+(int)(Math.random()*10)); //double 0.xxxxxxxxx

        Random random=new Random();
        int randomNumber=random.nextInt(10);
        System.out.println("난수발생:"+randomNumber);
