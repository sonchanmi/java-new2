...
public class Application01 {
    public static void main(String[] args) {
       ...
       // EnumSet 을 활용하여 여러 열거형 타입들을 set으로 취급할 수 있다.
        ...
        //특정 상수만 골라서 set에 추가 할 수 있다.
        System.out.println("==========================");
        EnumSet<UserRole2> usere = EnumSet.of(UserRole2.CONSUMER,UserRole2.PRODUCER);
        Iterator<UserRole2> userIter = usere.iterator();
        while (userIter.hasNext()){
            UserRole2 role= userIter.next();
            System.out.println(role.ordinal() + " "+role.getDescription());
        }

        //특정 상수를 제외하여 set에 추가 할 수 있다.
