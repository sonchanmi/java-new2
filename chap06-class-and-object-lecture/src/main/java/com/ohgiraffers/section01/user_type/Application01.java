...
public class Application01 {
    ...
    public static void main(String[] args) {
         ...
         * 2. 모든 회원 정보를 인자로 메소드 호출 시 전달하면 너무 많은 값들을 인자로 전달해야 하기엔 한 눈에 안들어 온다.
         ...
         * 아읻, 비밀번호, 이름, 나이 , 성별, 취미를 연속된 메모리 주소에서 사용하도록 heap에 공간을 만들었다
         *
         * */
         ...
         * "."은 창조연산자 라고 하는데, 레퍼런스 변수가 참고하고 있는 주소로 접근한다는 의미를 가진다.
         *  각 공간은 필드명으로 접근한다. (배열은 인덱스 접근, 객체는 필드명으로 접근한다)
         *
         * */
        ...
        gildong.age = 21;
        gildong.gender = 'g';
        gildong.hobby = new String[]{"축구,", "피구", "야구"};

        System.out.println("gildong=" + gildong.id);
        System.out.println("gildong=" + gildong.pwd);
        System.out.println("gildong=" + gildong.name);
        System.out.println("gildong=" + gildong.age);
        System.out.println("gildong=" + gildong.gender);
