...
public class Application01 {
    public static void main(String[] args) {
        ...
        *  -Vector , ArratList , LinkedList , Stack , Quene 등이 있다.
        *  2. Set 인터페이스
        ...
        *  HashMap, TreeMap, HashTable, Propertise 등이 있다.
        * */
        ...
        *
        *  ArrayList 는 배열의 단점을 보완하기 위해 만들어졌따,
        ...
        * */
        ...
        ArrayList alist = new ArrayList(); //값이 없는 10칸짜리 배열 생성됨
        ...
        /*
        *  Interator 란?
        *  Collection 인터페이스 interator()메소드를 이용해서 인스턴스를 생성할 수 있다.
        ...
        *  인덱스를 사용핮 않고도 반복문을 사용하기 위한 목록을 만들어 주는 역할이라고 보면 된다.
        *
