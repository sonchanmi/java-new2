...
public class Applicaition01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 메소드 재정의란 부모가 가지는 메소드 선언부를 개대로 사용하면서
        ...
        *
        * 장점과 단점을 고려했을 때
        * 상속은 재사용이라는 장점만 바라보게 되며 오용 가능성이 있기 때문에 유지보수에 좋지 않은 코드를 작성할 수 있다
       ...
       * */
        ...
        Car test= fireCar; // 부모클래스에 자식클래스를 넣어줄 수 있다.
...
//        FireCar fireCar1 = racingCar();  자식끼리는 쓸 수 없음
    }
}
