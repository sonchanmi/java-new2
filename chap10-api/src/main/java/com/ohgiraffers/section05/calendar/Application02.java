...
public class Application02 {
    public static void main(String[] args) {
        ...
        * 따라서 Calendar 클래스를 이용해서 인스턴스를 행성하는 것이 불가능 하다
        *
       ...
       // 2014년 9월 8일 16:42:00
        ...
        System.out.println("choice day: " + choiceDay);

        /*
        * 상황에 따라 특정 일자를 기준으로 한 Date 타입의 인스턴스가 필요한 경우도 있다.
        * 먼저 GregorianCalendar 를 이용해서 특정 날짜/ 시간 정보로 인스턴스를 생성한 후
        * 1970년 1월 1일 0시 0분 0초 를 기준으로 지난 시간을 millisecond 로 계산해서 long형으로
        * */
        ...
        // 각 필드에 매칭되는 매개변수의 위치 정수를 다 외워야 사용이 가능해 지기 떄문에
        // 상수 필드 형태로 제공을 하고 있다.
