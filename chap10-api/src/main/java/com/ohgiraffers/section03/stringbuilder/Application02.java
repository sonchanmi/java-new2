...
public class Application02 {
    public static void main(String[] args) {
        ...
        //capacity(): 용량(현재 버퍼의 크기)를 정수형으로 반환하는 메소드(문자열의 길이 + 16이 기본 용량)
        ...
        * */
        ...
        System.out.println("deleteChatAt(0):"+ sb2.deleteCharAt(0));
        ...
        * chatAt(). indexOf()/ lastIndecOf(). length(0, replace(),subString(), toString()
        * */
    }
}
